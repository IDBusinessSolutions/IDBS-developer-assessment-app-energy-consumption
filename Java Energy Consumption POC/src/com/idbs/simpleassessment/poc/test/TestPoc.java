...
public class TestPoc
{
    public boolean testThatCalculatedValuesForEachOfficeAreCorrect()
    {
        ...
        try
        {
            ...
            System.out.println(
                "Calculated energy used at Portland Maine Office is: " + test03Str + " Kw     (expected: 387.13 Kw)");
            ...
            System.out.println(
                "Calculated energy used at Alemeda California Office is: " + test04Str + " Kw     (expected: 4651.63 Kw)");
